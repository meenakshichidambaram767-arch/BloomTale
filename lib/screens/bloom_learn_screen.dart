      ...
      body: ListView(
        ...
        children: [
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Spacer(),
                    ElevatedButton(
                      onPressed: () => context.push('/stories/bursting_myths'),
          ...
          _buildLessonCard(
            ...
            description: 'Challenge a common menstrual myth with Ananya and discover what the facts really say.',
            duration: '3 min',
            xp: '+20 XP',
            storyId: 'bursting_myths',
          ),
          const SizedBox(height: 12),
          _buildLessonCard(
            context,
