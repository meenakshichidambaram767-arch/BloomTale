    ...
    return Align(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // Header Row: Companion Watercolor Icon & Title & Save/Audio Actions
            Row(
              children: [
                ClipOval(
                  child: Image.asset(
                ...
                // Save Answer / Journal Sync Button
                IconButton(
                  icon: Icon(
            ...
            // Level Toggle Bar (Simple vs Detail)
            ...
            // Related Learning Link Card if applicable
